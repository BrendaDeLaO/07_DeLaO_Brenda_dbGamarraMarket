...
('CNE', '122166133', 'Ana', 'Enríquez Flores', 'ana.enriquez@empresa.com', '', STR_TO_DATE('10/02/1970', '%d/%m/%Y')),
...
('DNI', '447142536','Alejandro', 'Jimenez Huapaya', '', '941525365', STR_TO_DATE('01/06/1989', '%d/%m/%Y')),
...
('CNE', '837953514', 'Luisa', 'Guerra Ibarra', 'luisa.guerra@yahoo.com', '974422136', STR_TO_DATE('21/12/1988', '%d/%m/%Y')),
('DNI', '74142585','Pedro Alfredo', 'Candela Valenzuela', 'pedro.candela@gmail.com', '94142585', STR_TO_DATE('30/06/1995', '%d/%m/%Y')),
...
('CNE', '757472186', 'Ocatavio Guillermo', 'Marquez Osorio', 'octavio.marquez@yahoo.es', '966223141', STR_TO_DATE('22/09/2000', '%d/%m/%Y')),
('CNE', '558693219', 'Manolo Enrique', 'Vasquez Saravia', 'manolo.vasquez@outlook.es', '966223141', STR_TO_DATE('22/09/2000', '%d/%m/%Y')),
('DNI', '41552567','Genoveva María', 'Ortíz Quispe', 'genoveva.ortis@outlook.es', '92564137', STR_TO_DATE('12/04/2003', '%d/%m/%Y')),
('DNI', '49985471','Oscar Carlos', 'Quiroz Zavala', '', '988223145', STR_TO_DATE('12/10/2004', '%d/%m/%Y')),
